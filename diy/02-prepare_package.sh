...
#sed -i "normal/dark/g" package/new/luci-theme-argon/luci-app-argon-config/root/etc/config/argon
...
sed -i 's/2.31.2/2.52.0/g' package/new/custom/filebrowser/Makefile
